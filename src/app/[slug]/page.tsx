...
import { Breadcrumbs, CategoryGrid, CtaBand, FaqList, HowItWorks, ReviewCard, SectionHead, SpecificGrid, TrustStrip } from "@/components/Sections";
  ...
  return (
    <>
      ...
      <section className="hero-bg relative overflow-hidden text-white">
        ...
        <VehicleIcon name={p.icon} className="pointer-events-none absolute -right-10 top-10 hidden h-96 w-[620px] text-blue/10 lg:block" />
        <Container className="relative grid gap-10 py-12 lg:grid-cols-[1.1fr_0.9fr] lg:py-16">
          <div>
            ...
            <h1 className="display mt-3 text-5xl leading-[0.92] sm:text-6xl lg:text-7xl">{p.h1}</h1>
          ...
          <div className="lg:sticky lg:top-28"><QuoteForm defaultType={p.formDefault} serviceName={p.name} /></div>
        </Container>
      </section>
      ...
      <section className="bg-white py-20">
        <Container className="grid grid-cols-1 gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="reveal rounded-2xl bg-navy p-7 text-white">
      ...
      <section className="bg-cloud py-16">
        <Container>
          ...
          <CategoryGrid exclude={parent?.slug ?? p.slug} />
        </Container>
      </section>
